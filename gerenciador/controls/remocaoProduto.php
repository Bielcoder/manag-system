...
<html>
   <head>
      ...
      <!-- Estilização Pura -->
      <link rel="stylesheet" href="../css/remocaoProduto.css">
   ...
   <body>
      ...
      <header>
         ...
         <div class="sub-navbar-meio">
            <div class="item-corpo-final">Remoção de Produtos</div>
         </div>
      </header>

      <aside>
    
       <form method="post" action="remocaoProduto.php">
       <div class="fieldset">    
          <div class="container">
             <p class="titulo-form">Remover Produto</p><br>
              <p><?php require_once('deleteProduto.php');?></p>
         <input type="text" name="codigo" class="form-control" placeholder="Codigo do Fabricante">
